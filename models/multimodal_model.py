# File: models/multimodal_model.py
import tensorflow as tf
from tensorflow.keras import layers, Model

def build_text_branch(vocab_size=10000, embedding_dim=128, max_length=100):
...
def build_multimodal_model(num_diseases=10):
    ...
    # Output: classification among 10 diseases
    output = layers.Dense(num_diseases, activation="softmax", name="diagnosis")(x)
